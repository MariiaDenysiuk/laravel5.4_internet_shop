...
@section('content')
    ...
    <div class="page-wrapper">
        <!-- Featured Image -->
        <div class="featured-image" style="background-image: url(images/featured-image/about.jpg);"></div>
                    ...
                    <div class="quotation padding-top">
                        <div class="quotation-author">
                            <div class="quotation-author-ava">
                                <img src="images/team/quote_author.jpg" alt="James Cameron">
                            </div>
                        </div>
                        <blockquote>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="teammate">
                        <div class="teammate-thumb">
                            ...
                            <img src="images/team/01.jpg" alt="Teammate">
                        </div>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="teammate">
                        <div class="teammate-thumb">
                            ...
                            <img src="images/team/02.jpg" alt="Teammate">
                        </div>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="teammate">
                        <div class="teammate-thumb">
                            ...
                            <img src="images/team/03.jpg" alt="Teammate">
                        </div>
                ...
                <div class="col-xs-6 col-md-3">
                    <div class="teammate">
                        <div class="teammate-thumb">
                            ...
                            <img src="images/team/04.jpg" alt="Teammate">
                        </div>
        ...
        <!-- Video Popup -->
        <div class="fw-section padding-top-3x padding-bottom-3x" style="background-image: url(images/video_bg.jpg);">
